...
/*
GPU程序执行时间: 11.662000 ms
*/

// CUDA核函数，执行并行规约操作
__global__ void reduceCompletrUnrollWarps8(int* g_odata, int* g_idata, unsigned int n) {
...
int main(int argc, char **argv) {
    ...
    reduceCompletrUnrollWarps8<<<grid.x/8, block.x>>>(d_odata, d_idata, size);
